const Services = () => {
  return (
    <>
      <section id="services" className="mb-10 pt-[96px]">
        <div className="mx-auto  px-4 sm:px-5 md:px-8 lg:px-10">
          <div className="text-center">
            <h2 className="section-title-h2">Services</h2>
            <p className="mb-0">
          ...
          <div className="grid lg:grid-cols-3 gap-3 md:gap-5 md:grid-cols-2 items-center justify-center  pt-[50px] md:px-10">
            <div className="col-lg-4 col-md-6 flex items-stretch mt-4 mt-md-0">
            ...
            <div className="col-lg-4 col-md-6 flex items-stretch mt-4 mt-lg-0">
            ...
            <div className="col-lg-4 col-md-6 flex items-stretch mt-4">
